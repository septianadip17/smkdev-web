...
import logoSMKDEV from "../assets/images/Logo-smkdev.png";
...
const Navbar = () => {
  ...
  const dropdownMenuClasses = `items-center justify-between w-full md:flex md:w-auto md:order-1 ${
    isOpen ? "block" : "hidden"
  }`;

  return (
    <nav className="bg-white border-gray-500 dark:bg-gray-800">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        >
          <img src={logoSMKDEV} className="h-8" alt="SMKDEV Logo" />
        </a>
        ...
        <div className={dropdownMenuClasses} id="navbar-cta">
